...
/**
 * Created by oksite on 2016/8/6 0006.
 */
...
// 执行默认任务
//gulp.task('default', ['less','minifyjs','testHtmlmin','testCssmin','imagemin', 'webserver', 'watch']);

//gulp.task('default', function() {
//    gulp.start('less','minifyjs','testHtmlmin','testCssmin','imagemin', 'webserver', 'watch');
//});
